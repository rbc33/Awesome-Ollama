...
| [Ghostbar](https://github.com/rbc33/Ghostbar) | Mac OS native :heavy_check_mark: <br /> Menu bar app :heavy_check_mark: <br /> Invisible to screen sharing :heavy_check_mark: <br /> Open Source :heavy_check_mark: | Download |
